## Module AWS.WAFRegional.Requests

#### `associateWebACL`

``` purescript
associateWebACL :: forall eff. Service -> AssociateWebACLRequest -> Aff (exception :: EXCEPTION | eff) AssociateWebACLResponse
```
...
``` purescript
createByteMatchSet :: forall eff. Service -> CreateByteMatchSetRequest -> Aff (exception :: EXCEPTION | eff) CreateByteMatchSetResponse
```
...
``` purescript
createGeoMatchSet :: forall eff. Service -> CreateGeoMatchSetRequest -> Aff (exception :: EXCEPTION | eff) CreateGeoMatchSetResponse
```
...
``` purescript
createRateBasedRule :: forall eff. Service -> CreateRateBasedRuleRequest -> Aff (exception :: EXCEPTION | eff) CreateRateBasedRuleResponse
```
...
``` purescript
createRegexMatchSet :: forall eff. Service -> CreateRegexMatchSetRequest -> Aff (exception :: EXCEPTION | eff) CreateRegexMatchSetResponse
```
...
``` purescript
createRegexPatternSet :: forall eff. Service -> CreateRegexPatternSetRequest -> Aff (exception :: EXCEPTION | eff) CreateRegexPatternSetResponse
```
...
``` purescript
createRule :: forall eff. Service -> CreateRuleRequest -> Aff (exception :: EXCEPTION | eff) CreateRuleResponse
```
...
``` purescript
createRuleGroup :: forall eff. Service -> CreateRuleGroupRequest -> Aff (exception :: EXCEPTION | eff) CreateRuleGroupResponse
```
...
``` purescript
createSizeConstraintSet :: forall eff. Service -> CreateSizeConstraintSetRequest -> Aff (exception :: EXCEPTION | eff) CreateSizeConstraintSetResponse
```
...
``` purescript
createSqlInjectionMatchSet :: forall eff. Service -> CreateSqlInjectionMatchSetRequest -> Aff (exception :: EXCEPTION | eff) CreateSqlInjectionMatchSetResponse
```
...
``` purescript
createWebACL :: forall eff. Service -> CreateWebACLRequest -> Aff (exception :: EXCEPTION | eff) CreateWebACLResponse
```
...
``` purescript
createXssMatchSet :: forall eff. Service -> CreateXssMatchSetRequest -> Aff (exception :: EXCEPTION | eff) CreateXssMatchSetResponse
```
...
``` purescript
deleteByteMatchSet :: forall eff. Service -> DeleteByteMatchSetRequest -> Aff (exception :: EXCEPTION | eff) DeleteByteMatchSetResponse
```
...
``` purescript
deleteGeoMatchSet :: forall eff. Service -> DeleteGeoMatchSetRequest -> Aff (exception :: EXCEPTION | eff) DeleteGeoMatchSetResponse
```
...
``` purescript
deletePermissionPolicy :: forall eff. Service -> DeletePermissionPolicyRequest -> Aff (exception :: EXCEPTION | eff) DeletePermissionPolicyResponse
```
...
``` purescript
deleteRateBasedRule :: forall eff. Service -> DeleteRateBasedRuleRequest -> Aff (exception :: EXCEPTION | eff) DeleteRateBasedRuleResponse
```
...
``` purescript
deleteRegexMatchSet :: forall eff. Service -> DeleteRegexMatchSetRequest -> Aff (exception :: EXCEPTION | eff) DeleteRegexMatchSetResponse
```
...
``` purescript
deleteRegexPatternSet :: forall eff. Service -> DeleteRegexPatternSetRequest -> Aff (exception :: EXCEPTION | eff) DeleteRegexPatternSetResponse
```
...
``` purescript
deleteRule :: forall eff. Service -> DeleteRuleRequest -> Aff (exception :: EXCEPTION | eff) DeleteRuleResponse
```
...
``` purescript
deleteRuleGroup :: forall eff. Service -> DeleteRuleGroupRequest -> Aff (exception :: EXCEPTION | eff) DeleteRuleGroupResponse
```
...
``` purescript
deleteSizeConstraintSet :: forall eff. Service -> DeleteSizeConstraintSetRequest -> Aff (exception :: EXCEPTION | eff) DeleteSizeConstraintSetResponse
```
...
``` purescript
deleteSqlInjectionMatchSet :: forall eff. Service -> DeleteSqlInjectionMatchSetRequest -> Aff (exception :: EXCEPTION | eff) DeleteSqlInjectionMatchSetResponse
```
...
``` purescript
deleteWebACL :: forall eff. Service -> DeleteWebACLRequest -> Aff (exception :: EXCEPTION | eff) DeleteWebACLResponse
```
...
``` purescript
deleteXssMatchSet :: forall eff. Service -> DeleteXssMatchSetRequest -> Aff (exception :: EXCEPTION | eff) DeleteXssMatchSetResponse
```
...
``` purescript
disassociateWebACL :: forall eff. Service -> DisassociateWebACLRequest -> Aff (exception :: EXCEPTION | eff) DisassociateWebACLResponse
```
...
``` purescript
getByteMatchSet :: forall eff. Service -> GetByteMatchSetRequest -> Aff (exception :: EXCEPTION | eff) GetByteMatchSetResponse
```
...
``` purescript
getChangeToken :: forall eff. Service -> GetChangeTokenRequest -> Aff (exception :: EXCEPTION | eff) GetChangeTokenResponse
```
...
``` purescript
getChangeTokenStatus :: forall eff. Service -> GetChangeTokenStatusRequest -> Aff (exception :: EXCEPTION | eff) GetChangeTokenStatusResponse
```
...
``` purescript
getGeoMatchSet :: forall eff. Service -> GetGeoMatchSetRequest -> Aff (exception :: EXCEPTION | eff) GetGeoMatchSetResponse
```
...
``` purescript
getPermissionPolicy :: forall eff. Service -> GetPermissionPolicyRequest -> Aff (exception :: EXCEPTION | eff) GetPermissionPolicyResponse
```
...
``` purescript
getRateBasedRule :: forall eff. Service -> GetRateBasedRuleRequest -> Aff (exception :: EXCEPTION | eff) GetRateBasedRuleResponse
```
...
``` purescript
getRateBasedRuleManagedKeys :: forall eff. Service -> GetRateBasedRuleManagedKeysRequest -> Aff (exception :: EXCEPTION | eff) GetRateBasedRuleManagedKeysResponse
```
...
``` purescript
getRegexMatchSet :: forall eff. Service -> GetRegexMatchSetRequest -> Aff (exception :: EXCEPTION | eff) GetRegexMatchSetResponse
```
...
``` purescript
getRegexPatternSet :: forall eff. Service -> GetRegexPatternSetRequest -> Aff (exception :: EXCEPTION | eff) GetRegexPatternSetResponse
```
...
``` purescript
getRule :: forall eff. Service -> GetRuleRequest -> Aff (exception :: EXCEPTION | eff) GetRuleResponse
```
...
``` purescript
getRuleGroup :: forall eff. Service -> GetRuleGroupRequest -> Aff (exception :: EXCEPTION | eff) GetRuleGroupResponse
```
...
``` purescript
getSampledRequests :: forall eff. Service -> GetSampledRequestsRequest -> Aff (exception :: EXCEPTION | eff) GetSampledRequestsResponse
```
...
``` purescript
getSizeConstraintSet :: forall eff. Service -> GetSizeConstraintSetRequest -> Aff (exception :: EXCEPTION | eff) GetSizeConstraintSetResponse
```
...
``` purescript
getSqlInjectionMatchSet :: forall eff. Service -> GetSqlInjectionMatchSetRequest -> Aff (exception :: EXCEPTION | eff) GetSqlInjectionMatchSetResponse
```
...
``` purescript
getWebACL :: forall eff. Service -> GetWebACLRequest -> Aff (exception :: EXCEPTION | eff) GetWebACLResponse
```
...
``` purescript
getWebACLForResource :: forall eff. Service -> GetWebACLForResourceRequest -> Aff (exception :: EXCEPTION | eff) GetWebACLForResourceResponse
```
...
``` purescript
getXssMatchSet :: forall eff. Service -> GetXssMatchSetRequest -> Aff (exception :: EXCEPTION | eff) GetXssMatchSetResponse
```
...
``` purescript
listActivatedRulesInRuleGroup :: forall eff. Service -> ListActivatedRulesInRuleGroupRequest -> Aff (exception :: EXCEPTION | eff) ListActivatedRulesInRuleGroupResponse
```
...
``` purescript
listByteMatchSets :: forall eff. Service -> ListByteMatchSetsRequest -> Aff (exception :: EXCEPTION | eff) ListByteMatchSetsResponse
```
...
``` purescript
listGeoMatchSets :: forall eff. Service -> ListGeoMatchSetsRequest -> Aff (exception :: EXCEPTION | eff) ListGeoMatchSetsResponse
```
...
``` purescript
listRateBasedRules :: forall eff. Service -> ListRateBasedRulesRequest -> Aff (exception :: EXCEPTION | eff) ListRateBasedRulesResponse
```
...
``` purescript
listRegexMatchSets :: forall eff. Service -> ListRegexMatchSetsRequest -> Aff (exception :: EXCEPTION | eff) ListRegexMatchSetsResponse
```
...
``` purescript
listRegexPatternSets :: forall eff. Service -> ListRegexPatternSetsRequest -> Aff (exception :: EXCEPTION | eff) ListRegexPatternSetsResponse
```
...
``` purescript
listResourcesForWebACL :: forall eff. Service -> ListResourcesForWebACLRequest -> Aff (exception :: EXCEPTION | eff) ListResourcesForWebACLResponse
```
...
``` purescript
listRuleGroups :: forall eff. Service -> ListRuleGroupsRequest -> Aff (exception :: EXCEPTION | eff) ListRuleGroupsResponse
```
...
``` purescript
listSizeConstraintSets :: forall eff. Service -> ListSizeConstraintSetsRequest -> Aff (exception :: EXCEPTION | eff) ListSizeConstraintSetsResponse
```
...
``` purescript
listSqlInjectionMatchSets :: forall eff. Service -> ListSqlInjectionMatchSetsRequest -> Aff (exception :: EXCEPTION | eff) ListSqlInjectionMatchSetsResponse
```
...
``` purescript
listSubscribedRuleGroups :: forall eff. Service -> ListSubscribedRuleGroupsRequest -> Aff (exception :: EXCEPTION | eff) ListSubscribedRuleGroupsResponse
```
...
``` purescript
listWebACLs :: forall eff. Service -> ListWebACLsRequest -> Aff (exception :: EXCEPTION | eff) ListWebACLsResponse
```
...
``` purescript
listXssMatchSets :: forall eff. Service -> ListXssMatchSetsRequest -> Aff (exception :: EXCEPTION | eff) ListXssMatchSetsResponse
```
...
``` purescript
putPermissionPolicy :: forall eff. Service -> PutPermissionPolicyRequest -> Aff (exception :: EXCEPTION | eff) PutPermissionPolicyResponse
```
...
``` purescript
updateByteMatchSet :: forall eff. Service -> UpdateByteMatchSetRequest -> Aff (exception :: EXCEPTION | eff) UpdateByteMatchSetResponse
```
...
``` purescript
updateGeoMatchSet :: forall eff. Service -> UpdateGeoMatchSetRequest -> Aff (exception :: EXCEPTION | eff) UpdateGeoMatchSetResponse
```
...
``` purescript
updateRateBasedRule :: forall eff. Service -> UpdateRateBasedRuleRequest -> Aff (exception :: EXCEPTION | eff) UpdateRateBasedRuleResponse
```
...
``` purescript
updateRegexMatchSet :: forall eff. Service -> UpdateRegexMatchSetRequest -> Aff (exception :: EXCEPTION | eff) UpdateRegexMatchSetResponse
```
...
``` purescript
updateRegexPatternSet :: forall eff. Service -> UpdateRegexPatternSetRequest -> Aff (exception :: EXCEPTION | eff) UpdateRegexPatternSetResponse
```
...
``` purescript
updateRule :: forall eff. Service -> UpdateRuleRequest -> Aff (exception :: EXCEPTION | eff) UpdateRuleResponse
```
...
``` purescript
updateRuleGroup :: forall eff. Service -> UpdateRuleGroupRequest -> Aff (exception :: EXCEPTION | eff) UpdateRuleGroupResponse
```
...
``` purescript
updateSizeConstraintSet :: forall eff. Service -> UpdateSizeConstraintSetRequest -> Aff (exception :: EXCEPTION | eff) UpdateSizeConstraintSetResponse
```
...
``` purescript
updateSqlInjectionMatchSet :: forall eff. Service -> UpdateSqlInjectionMatchSetRequest -> Aff (exception :: EXCEPTION | eff) UpdateSqlInjectionMatchSetResponse
```
...
``` purescript
updateWebACL :: forall eff. Service -> UpdateWebACLRequest -> Aff (exception :: EXCEPTION | eff) UpdateWebACLResponse
```
...
``` purescript
updateXssMatchSet :: forall eff. Service -> UpdateXssMatchSetRequest -> Aff (exception :: EXCEPTION | eff) UpdateXssMatchSetResponse
```
