...
module AWS.WAFRegional.Requests where
...
import AWS.WAFRegional as WAFRegional
import AWS.WAFRegional.Types as WAFRegionalTypes


-- | <p>Associates a web ACL with a resource.</p>
associateWebACL :: forall eff. WAFRegional.Service -> WAFRegionalTypes.AssociateWebACLRequest -> Aff (exception :: EXCEPTION | eff) WAFRegionalTypes.AssociateWebACLResponse
associateWebACL (WAFRegional.Service serviceImpl) = AWS.request serviceImpl method  where
    method = AWS.MethodName "associateWebACL"
...
createByteMatchSet :: forall eff. WAFRegional.Service -> WAFRegionalTypes.CreateByteMatchSetRequest -> Aff (exception :: EXCEPTION | eff) WAFRegionalTypes.CreateByteMatchSetResponse
createByteMatchSet (WAFRegional.Service serviceImpl) = AWS.request serviceImpl method  where
...
createGeoMatchSet :: forall eff. WAFRegional.Service -> WAFRegionalTypes.CreateGeoMatchSetRequest -> Aff (exception :: EXCEPTION | eff) WAFRegionalTypes.CreateGeoMatchSetResponse
createGeoMatchSet (WAFRegional.Service serviceImpl) = AWS.request serviceImpl method  where
...
createIPSet :: forall eff. WAFRegional.Service -> WAFRegionalTypes.CreateIPSetRequest -> Aff (exception :: EXCEPTION | eff) WAFRegionalTypes.CreateIPSetResponse
createIPSet (WAFRegional.Service serviceImpl) = AWS.request serviceImpl method  where
...
createRateBasedRule :: forall eff. WAFRegional.Service -> WAFRegionalTypes.CreateRateBasedRuleRequest -> Aff (exception :: EXCEPTION | eff) WAFRegionalTypes.CreateRateBasedRuleResponse
createRateBasedRule (WAFRegional.Service serviceImpl) = AWS.request serviceImpl method  where
...
createRegexMatchSet :: forall eff. WAFRegional.Service -> WAFRegionalTypes.CreateRegexMatchSetRequest -> Aff (exception :: EXCEPTION | eff) WAFRegionalTypes.CreateRegexMatchSetResponse
createRegexMatchSet (WAFRegional.Service serviceImpl) = AWS.request serviceImpl method  where
...
createRegexPatternSet :: forall eff. WAFRegional.Service -> WAFRegionalTypes.CreateRegexPatternSetRequest -> Aff (exception :: EXCEPTION | eff) WAFRegionalTypes.CreateRegexPatternSetResponse
createRegexPatternSet (WAFRegional.Service serviceImpl) = AWS.request serviceImpl method  where
...
createRule :: forall eff. WAFRegional.Service -> WAFRegionalTypes.CreateRuleRequest -> Aff (exception :: EXCEPTION | eff) WAFRegionalTypes.CreateRuleResponse
createRule (WAFRegional.Service serviceImpl) = AWS.request serviceImpl method  where
...
createRuleGroup :: forall eff. WAFRegional.Service -> WAFRegionalTypes.CreateRuleGroupRequest -> Aff (exception :: EXCEPTION | eff) WAFRegionalTypes.CreateRuleGroupResponse
createRuleGroup (WAFRegional.Service serviceImpl) = AWS.request serviceImpl method  where
...
createSizeConstraintSet :: forall eff. WAFRegional.Service -> WAFRegionalTypes.CreateSizeConstraintSetRequest -> Aff (exception :: EXCEPTION | eff) WAFRegionalTypes.CreateSizeConstraintSetResponse
createSizeConstraintSet (WAFRegional.Service serviceImpl) = AWS.request serviceImpl method  where
...
createSqlInjectionMatchSet :: forall eff. WAFRegional.Service -> WAFRegionalTypes.CreateSqlInjectionMatchSetRequest -> Aff (exception :: EXCEPTION | eff) WAFRegionalTypes.CreateSqlInjectionMatchSetResponse
createSqlInjectionMatchSet (WAFRegional.Service serviceImpl) = AWS.request serviceImpl method  where
...
createWebACL :: forall eff. WAFRegional.Service -> WAFRegionalTypes.CreateWebACLRequest -> Aff (exception :: EXCEPTION | eff) WAFRegionalTypes.CreateWebACLResponse
createWebACL (WAFRegional.Service serviceImpl) = AWS.request serviceImpl method  where
...
createXssMatchSet :: forall eff. WAFRegional.Service -> WAFRegionalTypes.CreateXssMatchSetRequest -> Aff (exception :: EXCEPTION | eff) WAFRegionalTypes.CreateXssMatchSetResponse
createXssMatchSet (WAFRegional.Service serviceImpl) = AWS.request serviceImpl method  where
...
deleteByteMatchSet :: forall eff. WAFRegional.Service -> WAFRegionalTypes.DeleteByteMatchSetRequest -> Aff (exception :: EXCEPTION | eff) WAFRegionalTypes.DeleteByteMatchSetResponse
deleteByteMatchSet (WAFRegional.Service serviceImpl) = AWS.request serviceImpl method  where
...
deleteGeoMatchSet :: forall eff. WAFRegional.Service -> WAFRegionalTypes.DeleteGeoMatchSetRequest -> Aff (exception :: EXCEPTION | eff) WAFRegionalTypes.DeleteGeoMatchSetResponse
deleteGeoMatchSet (WAFRegional.Service serviceImpl) = AWS.request serviceImpl method  where
...
deleteIPSet :: forall eff. WAFRegional.Service -> WAFRegionalTypes.DeleteIPSetRequest -> Aff (exception :: EXCEPTION | eff) WAFRegionalTypes.DeleteIPSetResponse
deleteIPSet (WAFRegional.Service serviceImpl) = AWS.request serviceImpl method  where
...
deletePermissionPolicy :: forall eff. WAFRegional.Service -> WAFRegionalTypes.DeletePermissionPolicyRequest -> Aff (exception :: EXCEPTION | eff) WAFRegionalTypes.DeletePermissionPolicyResponse
deletePermissionPolicy (WAFRegional.Service serviceImpl) = AWS.request serviceImpl method  where
...
deleteRateBasedRule :: forall eff. WAFRegional.Service -> WAFRegionalTypes.DeleteRateBasedRuleRequest -> Aff (exception :: EXCEPTION | eff) WAFRegionalTypes.DeleteRateBasedRuleResponse
deleteRateBasedRule (WAFRegional.Service serviceImpl) = AWS.request serviceImpl method  where
...
deleteRegexMatchSet :: forall eff. WAFRegional.Service -> WAFRegionalTypes.DeleteRegexMatchSetRequest -> Aff (exception :: EXCEPTION | eff) WAFRegionalTypes.DeleteRegexMatchSetResponse
deleteRegexMatchSet (WAFRegional.Service serviceImpl) = AWS.request serviceImpl method  where
...
deleteRegexPatternSet :: forall eff. WAFRegional.Service -> WAFRegionalTypes.DeleteRegexPatternSetRequest -> Aff (exception :: EXCEPTION | eff) WAFRegionalTypes.DeleteRegexPatternSetResponse
deleteRegexPatternSet (WAFRegional.Service serviceImpl) = AWS.request serviceImpl method  where
...
deleteRule :: forall eff. WAFRegional.Service -> WAFRegionalTypes.DeleteRuleRequest -> Aff (exception :: EXCEPTION | eff) WAFRegionalTypes.DeleteRuleResponse
deleteRule (WAFRegional.Service serviceImpl) = AWS.request serviceImpl method  where
...
deleteRuleGroup :: forall eff. WAFRegional.Service -> WAFRegionalTypes.DeleteRuleGroupRequest -> Aff (exception :: EXCEPTION | eff) WAFRegionalTypes.DeleteRuleGroupResponse
deleteRuleGroup (WAFRegional.Service serviceImpl) = AWS.request serviceImpl method  where
...
deleteSizeConstraintSet :: forall eff. WAFRegional.Service -> WAFRegionalTypes.DeleteSizeConstraintSetRequest -> Aff (exception :: EXCEPTION | eff) WAFRegionalTypes.DeleteSizeConstraintSetResponse
deleteSizeConstraintSet (WAFRegional.Service serviceImpl) = AWS.request serviceImpl method  where
...
deleteSqlInjectionMatchSet :: forall eff. WAFRegional.Service -> WAFRegionalTypes.DeleteSqlInjectionMatchSetRequest -> Aff (exception :: EXCEPTION | eff) WAFRegionalTypes.DeleteSqlInjectionMatchSetResponse
deleteSqlInjectionMatchSet (WAFRegional.Service serviceImpl) = AWS.request serviceImpl method  where
...
deleteWebACL :: forall eff. WAFRegional.Service -> WAFRegionalTypes.DeleteWebACLRequest -> Aff (exception :: EXCEPTION | eff) WAFRegionalTypes.DeleteWebACLResponse
deleteWebACL (WAFRegional.Service serviceImpl) = AWS.request serviceImpl method  where
...
deleteXssMatchSet :: forall eff. WAFRegional.Service -> WAFRegionalTypes.DeleteXssMatchSetRequest -> Aff (exception :: EXCEPTION | eff) WAFRegionalTypes.DeleteXssMatchSetResponse
deleteXssMatchSet (WAFRegional.Service serviceImpl) = AWS.request serviceImpl method  where
    method = AWS.MethodName "deleteXssMatchSet"


-- | <p>Removes a web ACL from the specified resource.</p>
disassociateWebACL :: forall eff. WAFRegional.Service -> WAFRegionalTypes.DisassociateWebACLRequest -> Aff (exception :: EXCEPTION | eff) WAFRegionalTypes.DisassociateWebACLResponse
disassociateWebACL (WAFRegional.Service serviceImpl) = AWS.request serviceImpl method  where
    method = AWS.MethodName "disassociateWebACL"


-- | <p>Returns the <a>ByteMatchSet</a> specified by <code>ByteMatchSetId</code>.</p>
getByteMatchSet :: forall eff. WAFRegional.Service -> WAFRegionalTypes.GetByteMatchSetRequest -> Aff (exception :: EXCEPTION | eff) WAFRegionalTypes.GetByteMatchSetResponse
getByteMatchSet (WAFRegional.Service serviceImpl) = AWS.request serviceImpl method  where
...
getChangeToken :: forall eff. WAFRegional.Service -> WAFRegionalTypes.GetChangeTokenRequest -> Aff (exception :: EXCEPTION | eff) WAFRegionalTypes.GetChangeTokenResponse
getChangeToken (WAFRegional.Service serviceImpl) = AWS.request serviceImpl method  where
...
getChangeTokenStatus :: forall eff. WAFRegional.Service -> WAFRegionalTypes.GetChangeTokenStatusRequest -> Aff (exception :: EXCEPTION | eff) WAFRegionalTypes.GetChangeTokenStatusResponse
getChangeTokenStatus (WAFRegional.Service serviceImpl) = AWS.request serviceImpl method  where
    method = AWS.MethodName "getChangeTokenStatus"


-- | <p>Returns the <a>GeoMatchSet</a> that is specified by <code>GeoMatchSetId</code>.</p>
getGeoMatchSet :: forall eff. WAFRegional.Service -> WAFRegionalTypes.GetGeoMatchSetRequest -> Aff (exception :: EXCEPTION | eff) WAFRegionalTypes.GetGeoMatchSetResponse
getGeoMatchSet (WAFRegional.Service serviceImpl) = AWS.request serviceImpl method  where
    method = AWS.MethodName "getGeoMatchSet"


-- | <p>Returns the <a>IPSet</a> that is specified by <code>IPSetId</code>.</p>
getIPSet :: forall eff. WAFRegional.Service -> WAFRegionalTypes.GetIPSetRequest -> Aff (exception :: EXCEPTION | eff) WAFRegionalTypes.GetIPSetResponse
getIPSet (WAFRegional.Service serviceImpl) = AWS.request serviceImpl method  where
    method = AWS.MethodName "getIPSet"


-- | <p>Returns the IAM policy attached to the RuleGroup.</p>
getPermissionPolicy :: forall eff. WAFRegional.Service -> WAFRegionalTypes.GetPermissionPolicyRequest -> Aff (exception :: EXCEPTION | eff) WAFRegionalTypes.GetPermissionPolicyResponse
getPermissionPolicy (WAFRegional.Service serviceImpl) = AWS.request serviceImpl method  where
...
getRateBasedRule :: forall eff. WAFRegional.Service -> WAFRegionalTypes.GetRateBasedRuleRequest -> Aff (exception :: EXCEPTION | eff) WAFRegionalTypes.GetRateBasedRuleResponse
getRateBasedRule (WAFRegional.Service serviceImpl) = AWS.request serviceImpl method  where
...
getRateBasedRuleManagedKeys :: forall eff. WAFRegional.Service -> WAFRegionalTypes.GetRateBasedRuleManagedKeysRequest -> Aff (exception :: EXCEPTION | eff) WAFRegionalTypes.GetRateBasedRuleManagedKeysResponse
getRateBasedRuleManagedKeys (WAFRegional.Service serviceImpl) = AWS.request serviceImpl method  where
...
getRegexMatchSet :: forall eff. WAFRegional.Service -> WAFRegionalTypes.GetRegexMatchSetRequest -> Aff (exception :: EXCEPTION | eff) WAFRegionalTypes.GetRegexMatchSetResponse
getRegexMatchSet (WAFRegional.Service serviceImpl) = AWS.request serviceImpl method  where
    method = AWS.MethodName "getRegexMatchSet"


-- | <p>Returns the <a>RegexPatternSet</a> specified by <code>RegexPatternSetId</code>.</p>
getRegexPatternSet :: forall eff. WAFRegional.Service -> WAFRegionalTypes.GetRegexPatternSetRequest -> Aff (exception :: EXCEPTION | eff) WAFRegionalTypes.GetRegexPatternSetResponse
getRegexPatternSet (WAFRegional.Service serviceImpl) = AWS.request serviceImpl method  where
...
getRule :: forall eff. WAFRegional.Service -> WAFRegionalTypes.GetRuleRequest -> Aff (exception :: EXCEPTION | eff) WAFRegionalTypes.GetRuleResponse
getRule (WAFRegional.Service serviceImpl) = AWS.request serviceImpl method  where
...
getRuleGroup :: forall eff. WAFRegional.Service -> WAFRegionalTypes.GetRuleGroupRequest -> Aff (exception :: EXCEPTION | eff) WAFRegionalTypes.GetRuleGroupResponse
getRuleGroup (WAFRegional.Service serviceImpl) = AWS.request serviceImpl method  where
...
getSampledRequests :: forall eff. WAFRegional.Service -> WAFRegionalTypes.GetSampledRequestsRequest -> Aff (exception :: EXCEPTION | eff) WAFRegionalTypes.GetSampledRequestsResponse
getSampledRequests (WAFRegional.Service serviceImpl) = AWS.request serviceImpl method  where
    method = AWS.MethodName "getSampledRequests"


-- | <p>Returns the <a>SizeConstraintSet</a> specified by <code>SizeConstraintSetId</code>.</p>
getSizeConstraintSet :: forall eff. WAFRegional.Service -> WAFRegionalTypes.GetSizeConstraintSetRequest -> Aff (exception :: EXCEPTION | eff) WAFRegionalTypes.GetSizeConstraintSetResponse
getSizeConstraintSet (WAFRegional.Service serviceImpl) = AWS.request serviceImpl method  where
...
getSqlInjectionMatchSet :: forall eff. WAFRegional.Service -> WAFRegionalTypes.GetSqlInjectionMatchSetRequest -> Aff (exception :: EXCEPTION | eff) WAFRegionalTypes.GetSqlInjectionMatchSetResponse
getSqlInjectionMatchSet (WAFRegional.Service serviceImpl) = AWS.request serviceImpl method  where
    method = AWS.MethodName "getSqlInjectionMatchSet"


-- | <p>Returns the <a>WebACL</a> that is specified by <code>WebACLId</code>.</p>
getWebACL :: forall eff. WAFRegional.Service -> WAFRegionalTypes.GetWebACLRequest -> Aff (exception :: EXCEPTION | eff) WAFRegionalTypes.GetWebACLResponse
getWebACL (WAFRegional.Service serviceImpl) = AWS.request serviceImpl method  where
    method = AWS.MethodName "getWebACL"


-- | <p>Returns the web ACL for the specified resource.</p>
getWebACLForResource :: forall eff. WAFRegional.Service -> WAFRegionalTypes.GetWebACLForResourceRequest -> Aff (exception :: EXCEPTION | eff) WAFRegionalTypes.GetWebACLForResourceResponse
getWebACLForResource (WAFRegional.Service serviceImpl) = AWS.request serviceImpl method  where
    method = AWS.MethodName "getWebACLForResource"


-- | <p>Returns the <a>XssMatchSet</a> that is specified by <code>XssMatchSetId</code>.</p>
getXssMatchSet :: forall eff. WAFRegional.Service -> WAFRegionalTypes.GetXssMatchSetRequest -> Aff (exception :: EXCEPTION | eff) WAFRegionalTypes.GetXssMatchSetResponse
getXssMatchSet (WAFRegional.Service serviceImpl) = AWS.request serviceImpl method  where
    method = AWS.MethodName "getXssMatchSet"


-- | <p>Returns an array of <a>ActivatedRule</a> objects.</p>
listActivatedRulesInRuleGroup :: forall eff. WAFRegional.Service -> WAFRegionalTypes.ListActivatedRulesInRuleGroupRequest -> Aff (exception :: EXCEPTION | eff) WAFRegionalTypes.ListActivatedRulesInRuleGroupResponse
listActivatedRulesInRuleGroup (WAFRegional.Service serviceImpl) = AWS.request serviceImpl method  where
    method = AWS.MethodName "listActivatedRulesInRuleGroup"


-- | <p>Returns an array of <a>ByteMatchSetSummary</a> objects.</p>
listByteMatchSets :: forall eff. WAFRegional.Service -> WAFRegionalTypes.ListByteMatchSetsRequest -> Aff (exception :: EXCEPTION | eff) WAFRegionalTypes.ListByteMatchSetsResponse
listByteMatchSets (WAFRegional.Service serviceImpl) = AWS.request serviceImpl method  where
    method = AWS.MethodName "listByteMatchSets"


-- | <p>Returns an array of <a>GeoMatchSetSummary</a> objects in the response.</p>
listGeoMatchSets :: forall eff. WAFRegional.Service -> WAFRegionalTypes.ListGeoMatchSetsRequest -> Aff (exception :: EXCEPTION | eff) WAFRegionalTypes.ListGeoMatchSetsResponse
listGeoMatchSets (WAFRegional.Service serviceImpl) = AWS.request serviceImpl method  where
    method = AWS.MethodName "listGeoMatchSets"


-- | <p>Returns an array of <a>IPSetSummary</a> objects in the response.</p>
listIPSets :: forall eff. WAFRegional.Service -> WAFRegionalTypes.ListIPSetsRequest -> Aff (exception :: EXCEPTION | eff) WAFRegionalTypes.ListIPSetsResponse
listIPSets (WAFRegional.Service serviceImpl) = AWS.request serviceImpl method  where
    method = AWS.MethodName "listIPSets"


-- | <p>Returns an array of <a>RuleSummary</a> objects.</p>
listRateBasedRules :: forall eff. WAFRegional.Service -> WAFRegionalTypes.ListRateBasedRulesRequest -> Aff (exception :: EXCEPTION | eff) WAFRegionalTypes.ListRateBasedRulesResponse
listRateBasedRules (WAFRegional.Service serviceImpl) = AWS.request serviceImpl method  where
    method = AWS.MethodName "listRateBasedRules"


-- | <p>Returns an array of <a>RegexMatchSetSummary</a> objects.</p>
listRegexMatchSets :: forall eff. WAFRegional.Service -> WAFRegionalTypes.ListRegexMatchSetsRequest -> Aff (exception :: EXCEPTION | eff) WAFRegionalTypes.ListRegexMatchSetsResponse
listRegexMatchSets (WAFRegional.Service serviceImpl) = AWS.request serviceImpl method  where
    method = AWS.MethodName "listRegexMatchSets"


-- | <p>Returns an array of <a>RegexPatternSetSummary</a> objects.</p>
listRegexPatternSets :: forall eff. WAFRegional.Service -> WAFRegionalTypes.ListRegexPatternSetsRequest -> Aff (exception :: EXCEPTION | eff) WAFRegionalTypes.ListRegexPatternSetsResponse
listRegexPatternSets (WAFRegional.Service serviceImpl) = AWS.request serviceImpl method  where
    method = AWS.MethodName "listRegexPatternSets"


-- | <p>Returns an array of resources associated with the specified web ACL.</p>
listResourcesForWebACL :: forall eff. WAFRegional.Service -> WAFRegionalTypes.ListResourcesForWebACLRequest -> Aff (exception :: EXCEPTION | eff) WAFRegionalTypes.ListResourcesForWebACLResponse
listResourcesForWebACL (WAFRegional.Service serviceImpl) = AWS.request serviceImpl method  where
    method = AWS.MethodName "listResourcesForWebACL"


-- | <p>Returns an array of <a>RuleGroup</a> objects.</p>
listRuleGroups :: forall eff. WAFRegional.Service -> WAFRegionalTypes.ListRuleGroupsRequest -> Aff (exception :: EXCEPTION | eff) WAFRegionalTypes.ListRuleGroupsResponse
listRuleGroups (WAFRegional.Service serviceImpl) = AWS.request serviceImpl method  where
    method = AWS.MethodName "listRuleGroups"


-- | <p>Returns an array of <a>RuleSummary</a> objects.</p>
listRules :: forall eff. WAFRegional.Service -> WAFRegionalTypes.ListRulesRequest -> Aff (exception :: EXCEPTION | eff) WAFRegionalTypes.ListRulesResponse
listRules (WAFRegional.Service serviceImpl) = AWS.request serviceImpl method  where
    method = AWS.MethodName "listRules"


-- | <p>Returns an array of <a>SizeConstraintSetSummary</a> objects.</p>
listSizeConstraintSets :: forall eff. WAFRegional.Service -> WAFRegionalTypes.ListSizeConstraintSetsRequest -> Aff (exception :: EXCEPTION | eff) WAFRegionalTypes.ListSizeConstraintSetsResponse
listSizeConstraintSets (WAFRegional.Service serviceImpl) = AWS.request serviceImpl method  where
    method = AWS.MethodName "listSizeConstraintSets"


-- | <p>Returns an array of <a>SqlInjectionMatchSet</a> objects.</p>
listSqlInjectionMatchSets :: forall eff. WAFRegional.Service -> WAFRegionalTypes.ListSqlInjectionMatchSetsRequest -> Aff (exception :: EXCEPTION | eff) WAFRegionalTypes.ListSqlInjectionMatchSetsResponse
listSqlInjectionMatchSets (WAFRegional.Service serviceImpl) = AWS.request serviceImpl method  where
    method = AWS.MethodName "listSqlInjectionMatchSets"


-- | <p>Returns an array of <a>RuleGroup</a> objects that you are subscribed to.</p>
listSubscribedRuleGroups :: forall eff. WAFRegional.Service -> WAFRegionalTypes.ListSubscribedRuleGroupsRequest -> Aff (exception :: EXCEPTION | eff) WAFRegionalTypes.ListSubscribedRuleGroupsResponse
listSubscribedRuleGroups (WAFRegional.Service serviceImpl) = AWS.request serviceImpl method  where
    method = AWS.MethodName "listSubscribedRuleGroups"


-- | <p>Returns an array of <a>WebACLSummary</a> objects in the response.</p>
listWebACLs :: forall eff. WAFRegional.Service -> WAFRegionalTypes.ListWebACLsRequest -> Aff (exception :: EXCEPTION | eff) WAFRegionalTypes.ListWebACLsResponse
listWebACLs (WAFRegional.Service serviceImpl) = AWS.request serviceImpl method  where
    method = AWS.MethodName "listWebACLs"


-- | <p>Returns an array of <a>XssMatchSet</a> objects.</p>
listXssMatchSets :: forall eff. WAFRegional.Service -> WAFRegionalTypes.ListXssMatchSetsRequest -> Aff (exception :: EXCEPTION | eff) WAFRegionalTypes.ListXssMatchSetsResponse
listXssMatchSets (WAFRegional.Service serviceImpl) = AWS.request serviceImpl method  where
...
putPermissionPolicy :: forall eff. WAFRegional.Service -> WAFRegionalTypes.PutPermissionPolicyRequest -> Aff (exception :: EXCEPTION | eff) WAFRegionalTypes.PutPermissionPolicyResponse
putPermissionPolicy (WAFRegional.Service serviceImpl) = AWS.request serviceImpl method  where
...
updateByteMatchSet :: forall eff. WAFRegional.Service -> WAFRegionalTypes.UpdateByteMatchSetRequest -> Aff (exception :: EXCEPTION | eff) WAFRegionalTypes.UpdateByteMatchSetResponse
updateByteMatchSet (WAFRegional.Service serviceImpl) = AWS.request serviceImpl method  where
...
updateGeoMatchSet :: forall eff. WAFRegional.Service -> WAFRegionalTypes.UpdateGeoMatchSetRequest -> Aff (exception :: EXCEPTION | eff) WAFRegionalTypes.UpdateGeoMatchSetResponse
updateGeoMatchSet (WAFRegional.Service serviceImpl) = AWS.request serviceImpl method  where
...
updateIPSet :: forall eff. WAFRegional.Service -> WAFRegionalTypes.UpdateIPSetRequest -> Aff (exception :: EXCEPTION | eff) WAFRegionalTypes.UpdateIPSetResponse
updateIPSet (WAFRegional.Service serviceImpl) = AWS.request serviceImpl method  where
...
updateRateBasedRule :: forall eff. WAFRegional.Service -> WAFRegionalTypes.UpdateRateBasedRuleRequest -> Aff (exception :: EXCEPTION | eff) WAFRegionalTypes.UpdateRateBasedRuleResponse
updateRateBasedRule (WAFRegional.Service serviceImpl) = AWS.request serviceImpl method  where
...
updateRegexMatchSet :: forall eff. WAFRegional.Service -> WAFRegionalTypes.UpdateRegexMatchSetRequest -> Aff (exception :: EXCEPTION | eff) WAFRegionalTypes.UpdateRegexMatchSetResponse
updateRegexMatchSet (WAFRegional.Service serviceImpl) = AWS.request serviceImpl method  where
...
updateRegexPatternSet :: forall eff. WAFRegional.Service -> WAFRegionalTypes.UpdateRegexPatternSetRequest -> Aff (exception :: EXCEPTION | eff) WAFRegionalTypes.UpdateRegexPatternSetResponse
updateRegexPatternSet (WAFRegional.Service serviceImpl) = AWS.request serviceImpl method  where
...
updateRule :: forall eff. WAFRegional.Service -> WAFRegionalTypes.UpdateRuleRequest -> Aff (exception :: EXCEPTION | eff) WAFRegionalTypes.UpdateRuleResponse
updateRule (WAFRegional.Service serviceImpl) = AWS.request serviceImpl method  where
...
updateRuleGroup :: forall eff. WAFRegional.Service -> WAFRegionalTypes.UpdateRuleGroupRequest -> Aff (exception :: EXCEPTION | eff) WAFRegionalTypes.UpdateRuleGroupResponse
updateRuleGroup (WAFRegional.Service serviceImpl) = AWS.request serviceImpl method  where
...
updateSizeConstraintSet :: forall eff. WAFRegional.Service -> WAFRegionalTypes.UpdateSizeConstraintSetRequest -> Aff (exception :: EXCEPTION | eff) WAFRegionalTypes.UpdateSizeConstraintSetResponse
updateSizeConstraintSet (WAFRegional.Service serviceImpl) = AWS.request serviceImpl method  where
...
updateSqlInjectionMatchSet :: forall eff. WAFRegional.Service -> WAFRegionalTypes.UpdateSqlInjectionMatchSetRequest -> Aff (exception :: EXCEPTION | eff) WAFRegionalTypes.UpdateSqlInjectionMatchSetResponse
updateSqlInjectionMatchSet (WAFRegional.Service serviceImpl) = AWS.request serviceImpl method  where
...
updateWebACL :: forall eff. WAFRegional.Service -> WAFRegionalTypes.UpdateWebACLRequest -> Aff (exception :: EXCEPTION | eff) WAFRegionalTypes.UpdateWebACLResponse
updateWebACL (WAFRegional.Service serviceImpl) = AWS.request serviceImpl method  where
...
updateXssMatchSet :: forall eff. WAFRegional.Service -> WAFRegionalTypes.UpdateXssMatchSetRequest -> Aff (exception :: EXCEPTION | eff) WAFRegionalTypes.UpdateXssMatchSetResponse
updateXssMatchSet (WAFRegional.Service serviceImpl) = AWS.request serviceImpl method  where
